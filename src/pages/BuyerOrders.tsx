...
const BuyerOrders = () => {
  ...
  const activeOrders = orders.filter((order) => ["confirmed", "shipped", "delivered"].includes(order.status));
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          <div className="glass-card-elevated rounded-2xl p-5">
            ...
            <p className="font-heading text-2xl font-extrabold mt-1">{orders.length}</p>
          </div>
          <div className="glass-card-elevated rounded-2xl p-5">
        ...
        {isLoading ? (
          ...
          <div className="glass-card rounded-3xl p-12 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Start browsing the catalog to place your first order.
            </p>

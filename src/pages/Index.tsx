          ...
          <>
            {newArrivalProducts.length > 0 ? (
              <ProductGrid
                ...
                title="New Arrivals From Your Suppliers"
                pageSize={3}
                role="buyer"
                emptyTitle="No new arrivals yet"
                emptyDescription="Your subscribed suppliers have not published anything new in the last few days."
              />
            ) : user ? (
              <section className="max-w-6xl mx-auto px-4 md:px-6 mt-10">
                <div className="glass-card-elevated rounded-3xl p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-primary">New Arrivals</p>
                    <h2 className="font-heading text-2xl font-extrabold mt-2">Subscribe to suppliers to tailor your feed</h2>
                    <p className="text-sm text-muted-foreground mt-2 max-w-2xl">
                      Follow the suppliers you trust and we will surface their newest listings here first.
                    </p>
                  </div>
        ...
        {isSupplier ? (
          <section className="max-w-6xl mx-auto px-4 md:px-6 mt-10">
            <div className="flex items-center justify-between gap-4 flex-wrap mb-6">
              <div>
                <span className="text-[10px] font-bold text-accent tracking-widest uppercase">Supplier View</span>
                <h2 className="font-heading text-2xl font-bold mt-1">Your Products</h2>
                <p className="text-sm text-muted-foreground mt-1">
                  This view is tailored to supplier activity, not buyer shopping.
                </p>
              </div>
            ...
            <ProductGrid
              ...
              pageSize={6}
              role="supplier"
              emptyTitle="No listed products yet"
              emptyDescription="Add your first product to start appearing across the platform."
            />
          </section>
        ) : (
          <ProductGrid
